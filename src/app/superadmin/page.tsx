                        ...
                        {emp.mestre ? (
                          <div>
                            <div className="flex items-center gap-2">
                              <span className="text-slate-300 font-medium">{emp.mestre.nome}</span>
                              {emp.whatsapp_contato && (
                                <a
                                  href={`https://wa.me/${emp.whatsapp_contato.replace(/\D/g, '')}`}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="text-emerald-500 hover:text-emerald-400 p-0.5 rounded transition-all hover:scale-105 active:scale-95 inline-flex items-center justify-center cursor-pointer"
                                  title={`Falar no WhatsApp: ${emp.whatsapp_contato}`}
                                >
